...
int main(int, char **)
{
    ...
    Shader ourShader("/home/zihao/Desktop/workspace/my_gui_project/data/shader/matrix.vert", "/home/zihao/Desktop/workspace/my_gui_project/data/shader/matrix.frag");
    ourShader.use();
